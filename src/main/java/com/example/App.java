...
public class App {
    public static void main(String[] args) {
        ...
        /* creacion de objetos bicicleta */
        BiciMontana biciMontana = BiciMontana.builder()
                .marca("bmw")
                .asientos(4)
                .engranajes(20)
                .velocidad(200)
        ...
        BiciElectrica biciElectrica = BiciElectrica.builder()
                .marca("bmw")
                .asientos(4)
                .engranajes(20)
                .velocidad(200)
                .autonomia(Autonomia.MEDIA)
                .build();
        System.out.println(biciMontana);
